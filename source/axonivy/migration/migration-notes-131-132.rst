...
For more details about the Axon Ivy Java API and to troubleshoot issues, refer to `Troubleshoot Java Compilation Errors <https://community.axonivy.com/d/1150>`_.
