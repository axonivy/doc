...
- VS Code will take care of updating the extensions automatically. You don't have to configure or update extension versions unless you want to work with a specific version as described in :ref:`designer-advanced-setup`.
