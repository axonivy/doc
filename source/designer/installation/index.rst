...
Notes & Tipps
-------------
- Keep VS Code up-to-date. VS Code itself has weekly releases and will often prompt you to update. Not doing so might breaks the Extensions funtionality.
- VS Code will take care of updating the extensions automatically. You don't have to confiugre or update extension versions unless you want to work with a specific version as decribed in :ref:`designer-advanced-project-setup`.
- The Axon Ivy extension automatcially installs the neccessary Java and Maven extensions. They are also keep up-to-date by VS Code. Those extensions are needed for the Axon Ivy extension to properly work. This means that, apart from having a working Java and Maven installation on your system as described in the :ref:`designer-install-comprehensive-requirements`, you don't have to install any other VS Code extensions apart from the Axon Ivy extension itself.
