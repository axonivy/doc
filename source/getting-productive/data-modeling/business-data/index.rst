...
The Business Data feature allows you to store and load business data in a
...
database. This allows you to add fields to data classes over time and still
be able to load old business data without migration.

Moreover, the business data feature allows you to search the stored data by
